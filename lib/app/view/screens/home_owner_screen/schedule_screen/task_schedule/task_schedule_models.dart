...
class TaskScheduleModels {
  ...
  factory TaskScheduleModels.fromRawJson(String str) =>
      TaskScheduleModels.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory TaskScheduleModels.fromJson(Map<String, dynamic> json) =>
      TaskScheduleModels(
        id: json["_id"],
        user: json["user"],
